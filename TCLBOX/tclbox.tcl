...
#puts "Clock_early_rise_delay starts at : $clock_early_rise_delay_start"
...
#puts "Clock_early_fall_delay starts at : $clock_early_fall_delay_start"
...
#puts "Clock_late_rise_delay starts at : $clock_late_rise_delay_start"
...
#now writing the input constraints for sdc:
...
while {$i < $end_of_ports} {
#------------------------------------optional----------differentiating output ports as bussed and bits-------------------#
set netlist [glob -dir $NetlistDirectory *.v]
set tmp_file [open /tmp/1 w]
foreach f $netlist {
        set fd [open $f]
...
source /workspaces/vsd-tcl/vsdsynth/procs/reopenStdout.proc
source /workspaces/vsd-tcl/vsdsynth/procs/set_num_threads.proc
reopenStdout $OutputDirectory/$DesignName.conf
set_multi_cpu_usage -localCpu 2
#return

source /workspaces/vsd-tcl/vsdsynth/procs/read_lib.proc
read_lib -early /workspaces/vsd-tcl/vsdsynth/osu018_stdcells.lib

read_lib -late /workspaces/vsd-tcl/vsdsynth/osu018_stdcells.lib

source /workspaces/vsd-tcl/vsdsynth/procs/read_verilog.proc
read_verilog $OutputDirectory/$DesignName.final.synth.v

source /workspaces/vsd-tcl/vsdsynth/procs/read_sdc.proc
...
set time_elapsed_in_us [time {exec /bin/OpenTimer < $OutputDirectory/$DesignName.conf >& $OutputDirectory/$DesignName.results} 1]
